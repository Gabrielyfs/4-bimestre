        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <View style={styles.avatar}>
                    <Ionicons name="person" color={"#ccc"} size={60} />
                </View>
                <Text style={styles.fullName}>Gabriely Félix</Text>
                <Text style={styles.userName}>@gabyfelix</Text>
            </View>
                ...
                <TouchableOpacity style={styles.settingItem}>
                    <View style={styles.settingLeft}>
                        ...
                        <View style={styles.settingText}>
                            ...
                            <Text style={styles.settingValue}>Gabriely Félix</Text>
                        </View>
                    </View>
                ...
                <TouchableOpacity style={styles.settingItem}>
                    <View style={styles.settingLeft}>
                        ...
                        <View style={styles.settingText}>
                            ...
                            <Text style={styles.settingValue}>gabriey@gmail.com</Text>
                        </View>
                    </View>
                    <Ionicons name="chevron-forward" size={20} color={"#666666"} />
                </TouchableOpacity>
